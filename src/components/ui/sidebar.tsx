...
export function SidebarDivider({
	className,
	...props
}: Readonly<React.ComponentPropsWithoutRef<"hr">>) {
	return (
		<hr
			{...props}
			className={clsx(
				className,
				"my-4 border-zinc-950/5 border-t lg:-mx-4 dark:border-white/5"
			)}
		/>
	);
}
...
export function SidebarHeading({
	...
	children,
	...props
}: Readonly<React.ComponentPropsWithoutRef<"h3">>) {
	return (
		<h3
			{...props}
			className={clsx(
...
type SidebarItemProps = {
	...
	| (Omit<React.ComponentPropsWithoutRef<"a">, "type" | "className" | "ref"> & {
			href: string;
			to?: never;
	  })
);
