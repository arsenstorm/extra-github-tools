...
function MobileSidebar({
	...
	return (
		<HeadlessTransition show={open}>
			<HeadlessDialog className="lg:hidden" onClose={close}>
				...
				>
					<HeadlessDialogPanel className="fixed inset-y-0 w-full max-w-80 p-2 transition">
